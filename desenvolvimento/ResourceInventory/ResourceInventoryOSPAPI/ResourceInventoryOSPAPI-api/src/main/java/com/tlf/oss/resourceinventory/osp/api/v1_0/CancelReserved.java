...
import com.tlf.oss.resourceinventory.osp.core.CancelReservedController;
...
@Stateless
@Path("cancelReserved")
public class CancelReserved extends RestInterceptor {
	
	@Inject
	private CancelReservedController cancelReservedController;

	/**
	 * Método que irá fazer o cancelamento da reserva
	 * @param entity
	 * @return
	...
	public Response doExecution(ResourceInventoryEntity entity) throws OSSBusinessException {
		...
		try {
			logger.log(OSSLogger.INFO, "Executing cancellation reservation");
			ResourceInventoryEntity response = cancelReservedController.doExecution(entity);
		    ...
		    logger.log(OSSLogger.ERROR, "CancelReserved- WebMethod doExecution =[" + e.getMessage() + "]");
		    throw OssBusinessExceptionFactory.getOSSBusinessException(e, "CancelReserved");
		}
	}
