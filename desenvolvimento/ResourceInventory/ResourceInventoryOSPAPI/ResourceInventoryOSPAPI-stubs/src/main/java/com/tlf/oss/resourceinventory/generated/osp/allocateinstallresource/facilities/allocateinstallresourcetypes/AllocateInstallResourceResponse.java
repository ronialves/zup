...
import com.tlf.oss.resourceinventory.generated.osp.allocateinstallresource.supplementaryinformationallocatetypes.SupplementaryInformationOut;


/**
 * <p>Classe Java de AllocateInstallResourceResponse complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="AllocateInstallResourceResponse"&gt;
 *   &lt;complexContent&gt;
 ...
 *                   &lt;element name="circuitQuantity" type="{http://www.cpqd.com.br/etics/simpletypes}integer5"/&gt;
 ...
 *                     &lt;/simpleType&gt;
 *                   &lt;/element&gt;
 *                   &lt;element name="relatedCircuits" type="{http://www.cpqd.com.br/etics/CircuitResourceTypes}CircuitAllocate" minOccurs="0"/&gt;
 *                   &lt;element name="supplementaryInformation" type="{http://www.cpqd.com.br/etics/SupplementaryInformationAllocateTypes}SupplementaryInformationOut" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "AllocateInstallResourceResponse", propOrder = {
    "result",
    "informations"
})
public class AllocateInstallResourceResponse {

    @XmlElement(required = true)
    protected ResultTypeWithErrorCode result;
    protected List<AllocateInstallResourceResponse.Informations> informations;
     ...
     * {@link AllocateInstallResourceResponse.Informations }
     * 
     * 
     */
    public List<AllocateInstallResourceResponse.Informations> getInformations() {
        if (informations == null) {
            informations = new ArrayList<AllocateInstallResourceResponse.Informations>();
        }
    ...
    public static class Informations {
        ...
        protected int circuitQuantity;
        @XmlElement(required = true, defaultValue = "0")
        protected String statusNetwork;
        protected CircuitAllocate relatedCircuits;
        ...
        /**
         * Obtém o valor da propriedade circuitQuantity.
         * 
         */
        public int getCircuitQuantity() {
            return circuitQuantity;
        }

        /**
         * Define o valor da propriedade circuitQuantity.
         * 
         */
        public void setCircuitQuantity(int value) {
         ...
         * @return
         *     possible object is
         *     {@link CircuitAllocate }
         *     
         */
        public CircuitAllocate getRelatedCircuits() {
         ...
         *     
         */
        public void setRelatedCircuits(CircuitAllocate value) {
