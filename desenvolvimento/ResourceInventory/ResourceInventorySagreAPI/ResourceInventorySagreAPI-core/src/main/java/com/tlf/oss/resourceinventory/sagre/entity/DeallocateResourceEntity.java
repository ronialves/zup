 ...
 */
@Entity
@NamedStoredProcedureQuery(name = "DeallocateResource", resultClasses = DeallocateResourceEntity.class, procedureName = "SAGREMAN.GVT_SP_SOA_LIBERA_FAC_CTRL", parameters = {
...
public class DeallocateResourceEntity implements Serializable {
	...
	public DeallocateResourceEntity() {
		super();
	}

	public DeallocateResourceEntity(Integer cnl, String accessTechnology, String voiceTechnology, String accessId,
