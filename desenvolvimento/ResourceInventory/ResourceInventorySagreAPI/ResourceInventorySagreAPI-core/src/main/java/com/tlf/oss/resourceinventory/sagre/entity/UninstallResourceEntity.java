 ...
 */
@Entity
@NamedStoredProcedureQuery(name = "UninstallResource", resultClasses = UninstallResourceEntity.class, procedureName = "SAGREMAN.GVT_SP_SOA_LIBERA_FAC_CTRL", parameters = {
...
public class UninstallResourceEntity implements Serializable {
	...
	public UninstallResourceEntity() {
		super();
	}

	public UninstallResourceEntity(Integer cnl, String accessTechnology, String voiceTechnology, String accessId,
