...
import com.tlf.oss.resourceinventory.granite.core.AllocateResourceController;
...
public class AllocateService extends RestInterceptor {
	...
	@Inject
	private AllocateResourceController allocateResourceController;
	...
	public Response doExecution(ResourceInventoryEntity entity) throws OSSBusinessException {
		allocateResourceController.allocateResource(entity);
