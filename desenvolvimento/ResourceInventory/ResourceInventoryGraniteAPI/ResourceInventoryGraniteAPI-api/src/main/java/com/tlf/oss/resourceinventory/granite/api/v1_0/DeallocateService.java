...
import com.tlf.oss.resourceinventory.granite.core.DeallocateResourceController;
...
public class DeallocateService extends RestInterceptor {
	...
	@Inject
	private DeallocateResourceController deallocateResourceController;
	...
	public Response doExecution(ResourceInventoryEntity entity) throws OSSBusinessException {
		deallocateResourceController.deallocateResource(entity);
