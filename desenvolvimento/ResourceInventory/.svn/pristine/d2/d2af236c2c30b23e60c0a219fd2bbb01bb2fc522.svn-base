...
@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name = SlotDetailEntity.SLOT_DETAIL, resultClasses = SlotDetailEntity.class, procedureName = "PKG_RESERVE.PRC_RETRIEVE_SLOTS_DETAIL",
	parameters = {
			@StoredProcedureParameter(mode = ParameterMode.IN, name = "p_in_hostname", type = String.class),
...
public class SlotDetailEntity implements Serializable{

	private static final long serialVersionUID = 1L;
	
	public static final String SLOT_DETAIL = "slotDetail";
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SlotDetailEntity other = (SlotDetailEntity) obj;
		if (cardInstId == null) {
