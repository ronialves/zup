package com.tlf.oss.resourceinventory.sophia.core.entity;
...
import com.tlf.oss.resourceinventory.granite.core.entity.EntityCommon;
import com.tlf.oss.resourceinventory.granite.core.to.ResultTo;

@Table(name="equip_attr_settings")
@Entity
@NamedNativeQueries({
	@NamedNativeQuery(name="QueryFacilityGpon", query="SELECT tecnology,"
			...
			+ "nasport,"
			+ "Access_side_z.model nis_ip_type,"
			+ "Access_side_z.vendor aggregator_equipment_vendor,"
			+ "nasip,"
			+ "network_vlan,"
			+ "user_vlan,"
			+ "vlan_voip,"
			...
			+ " 						DECODE(ei_olt.vendor,'ERICSSON',ei_olt.shelf,'HUAWEI TECHNOLOGIES',ei_olt.shelf,NULL) AS equipament_subrack,"
			+ "					   (SELECT ease.attr_value"
			+ "						  FROM val_attr_name vana, equip_attr_settings ease	"
			+ "					   WHERE vana.group_name = 'EQUIPAMENTO_ENGENHARIA' "
...
, resultClass = RetrieveFacilityResourceGponEntity.class)
})
public class RetrieveFacilityResourceGponEntity extends EntityCommon<Long> implements Serializable {
	...
	@Basic
	@Column(name="nis_ip_type")
	private String nisIpType;

	@Basic
	@Column(name="aggregator_equipment_vendor")
	private String aggregatorEquipVendor;
	...
	public String getNisIpType() {
		return nisIpType;
	}

	public void setNisIpType(String nisIpType) {
		this.nisIpType = nisIpType;
	}

	public String getAggregatorEquipVendor() {
		return aggregatorEquipVendor;
	}

	public void setAggregatorEquipVendor(String aggregatorEquipVendor) {
		this.aggregatorEquipVendor = aggregatorEquipVendor;
	}
