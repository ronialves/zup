...
@Entity
@NamedStoredProcedureQuery(name = "uninstallResourceGponEntity", resultClasses = UninstallResourceGponEntity.class,procedureName = "PKG_ALLOCATE.PRC_CANCEL_ALLOCATE_GPON",
parameters = {
...
})public class UninstallResourceGponEntity extends EntityCommon<Long> implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	public UninstallResourceGponEntity() {
		super();
	}
	
	public UninstallResourceGponEntity(String terminal, String code, String description, ResultTo result) {
		super();
