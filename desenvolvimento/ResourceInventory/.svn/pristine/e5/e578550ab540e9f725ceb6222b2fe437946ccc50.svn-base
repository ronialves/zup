...
public class UpdateSTBControllerTest {
	...
	public void before() {
		...
		entity.getCustomerFacingService().get(0).getServiceDescribedBy().add(createServiceDescribedBy(CpeConstants.CASN, "A1B2C3D4E5F6G7H8J9I0"));
	...
	@Test
	public void testUpdateSTBCeaseSuccess() throws OSSBusinessException {
		...
		CatalogoDispositivo equipment = getCatalogoDispositivo();
		List<DispositivoFisico> dispositivos = getDispositivosFisico();
		dispositivos.get(0).setNumeroSerial("100000");
	...
	public void testUpdateSTBCeaseDispositivoFisicoFoundException() throws OSSBusinessException {
	...
	@Test(expected = OSSBusinessException.class)
	public void testUpdateSTBCeaseRecursoLogicoIsNullException() throws OSSBusinessException {
