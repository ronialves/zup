...
public class NetworkInfoEntity implements Serializable {
	...
	@Basic
	@Column(name = "V_CVLAN_CALCULADO")
	private String cvlanCalculado;
	...
	public String getCvlanCalculado() {
	    return this.cvlanCalculado;
    }

    public void setCvlanCalculado(String cvlanCalculado) {
	    this.cvlanCalculado = cvlanCalculado;
    }
