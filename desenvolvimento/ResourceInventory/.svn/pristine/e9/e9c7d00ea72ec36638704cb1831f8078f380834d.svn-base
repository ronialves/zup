package com.tlf.oss.resourceinventory.granite.api.faultmanagement.v1_0;
...
import com.tlf.oss.resourceinventory.granite.core.EquipmentRetrievalController;
...
public class EquipmentRetrievalService extends RestInterceptor {
	...
	public Response doExecution(ResourceInventoryEntity entity) throws OSSBusinessException {
		...
		return Response.status(Status.OK).entity(controller.retrieval(entity)).build();
	}
}