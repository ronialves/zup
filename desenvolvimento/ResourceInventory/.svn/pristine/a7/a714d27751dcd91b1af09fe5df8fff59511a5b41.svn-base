...
@XmlType(name = "UpdateResourceOut", propOrder = { "brazilianUrbanPropertyAddress", "resourceFacingService", "customerFacingServices", "customerOrder", "resourceOrder" })
public class UpdateResourceOut {
