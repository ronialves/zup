...
@XmlType(name = "UninstallResourceIn", propOrder = { "brazilianUrbanPropertyAddress", "resourceFacingService", "customerOrder","customerFacingServices","resourceOrder"})
public class UninstallResourceIn {
