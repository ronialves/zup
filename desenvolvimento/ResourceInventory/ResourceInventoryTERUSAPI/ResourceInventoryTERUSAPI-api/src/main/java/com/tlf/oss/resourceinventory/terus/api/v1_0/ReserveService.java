...
import com.tlf.oss.resourceinventory.terus.core.ReservationController;
...
public class ReserveService extends RestInterceptor {
	...
	public Response doExecution(ResourceInventoryEntity entity) {
		...
		try {
			...
			controller.lock(entity);			
		
		} catch (OSSBusinessException e) {
			logger.log(OSSLogger.ERROR, "Terus API - WebMethod doExecution =[" + e.getMessage() + "]");
