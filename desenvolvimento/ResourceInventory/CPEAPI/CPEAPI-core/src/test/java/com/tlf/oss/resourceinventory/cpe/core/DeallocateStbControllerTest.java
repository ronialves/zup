...
public class DeallocateStbControllerTest {
	...
	public void deallocateSuccess() throws OSSBusinessException {
		...
		when(servicoAssinanteRepository.findByServiceId(anyObject())).thenReturn(servicoAssinante);
	...
	public void deallocateOSSException() throws OSSBusinessException {
	...
	public void deallocateException() throws OSSBusinessException {
		when(deallocateStbController.deallocate(entity)).thenThrow(Exception.class);
